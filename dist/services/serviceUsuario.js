...
var serviceUsuario = /** @class */ (function () {
    ...
    serviceUsuario.prototype.adicionarUsuario = function (usuario) {
    ...
    serviceUsuario.prototype.buscarUsuarios = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.repositoryUsuario.getAll()];
            });
        });
    };
    serviceUsuario.prototype.buscarUsuarioPorCPF = function (cpf) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.repositoryUsuario.getByCpf(cpf)];
            });
        });
    };
    serviceUsuario.prototype.deletarUsuario = function (usuario) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.repositoryUsuario.getByCpf(usuario.getCpf())) {
    ...
    serviceUsuario.prototype.mudarUsuario = function (usuario) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.repositoryUsuario.getByCpf(usuario.getCpf())) {
                    throw new Error("Usuario não encontrado!");
...
exports.serviceUsuario = serviceUsuario;
