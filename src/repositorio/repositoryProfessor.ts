...
export class repositoryProfessor {
    ...
    update(professor: Professor){
      const query = `update Professor set idDepartamento = ${professor.getDepartamento().getID}, nroUniversidade = ${professor.getUniversidade}, statusBiblioteca = ${professor.getStatusBiblioteca} where cpfUsuario = ${professor.getCpf()}`;
    }
  }